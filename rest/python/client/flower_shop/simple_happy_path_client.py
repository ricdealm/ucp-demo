...
""")
  ...
  try:
    ...
    buyer_req = {"full_name": "John Doe", "email": "john.doe@example.com"}
    ...
    # Use a dict for the payload instead of non-existent PaymentData
    final_payload = {
      "payment_data": wrapped_instr.model_dump(mode="json", by_alias=True, exclude_none=True)
    }
